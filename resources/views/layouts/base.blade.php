										...
										@if(Auth::user()->utype === 'ADM')
											...
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="تنظیمات دسته‌های اصلی" href="{{ route('admin.homecategories') }}">تنظیمات دسته‌های اصلی</a>
													</li>
													<li class="menu-item" >
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{ route('shop') }}" class="link-term mercado-item-title">فروشگاه</a>
								</li>
								<li class="menu-item">
									<a href="{{ route('cart') }}" class="link-term mercado-item-title">سبد خرید</a>
								</li>
								<li class="menu-item">
									<a href="{{ route('checkout') }}" class="link-term mercado-item-title">پرداخت صورت حساب</a>
								</li>
								<li class="menu-item">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							...
							<div class="wrap-footer-item">
								<h3 class="item-header">پاسخگویی شبانه‌روزی</h3>
								<div class="item-content">
									<div class="wrap-hotline-footer">
										<span class="desc">تماس به صورت کاملاً رایگان</span>
										<b class="phone-number">(021) 456 789 2 - (021) 666 888 2</b>
									</div>
								</div>
							</div>

							<div class="wrap-footer-item footer-item-second">
								<h3 class="item-header">دریافت خبرنامه‌های جدید</h3>
								<div class="item-content">
									<div class="wrap-newletter-footer">
										<form action="#" class="frm-newletter" id="frm-newletter">
											<input type="email" class="input-email" name="email" value="" placeholder="ایمیل خود را وارد نمایید">
											<button class="btn-submit">عضویت</button>
										</form>
									</div>
								</div>
							</div>
