      ...
      <div class="summary">
        <div class="order-summary">
          ...
          @if(session()->has('coupon'))
            <p class="summary-info"><span class="title">Discount ({{ session('coupon')['code'] }}) <a><i class="fa fa-times text-danger"></i></a></span><b class="index"> -${{ number_format($discount, 2) }}</b></p>
